...
class PaletteEditionCardSelect extends React.PureComponent {
    handleChange = (name, value) => {
        this.props.onChange('palette', this.props.name, value);
    };
...
export default withStyles(styles)(PaletteEditionCardSelect);
